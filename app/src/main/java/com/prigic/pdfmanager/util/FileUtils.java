...
import static com.prigic.pdfmanager.util.Constants.PATH_SEPERATOR;
...
import static com.prigic.pdfmanager.util.FileUriUtils.getUriRealPathAboveKitkat;
import static com.prigic.pdfmanager.util.FileUriUtils.isWhatsappImage;
...
public class FileUtils {
    ...
    public void openFile(String path) {
        ...
        try {
            if(mContext==null){
                Log.d("fileViewError","mContext: is null");
            }
