...
public class CreatePdf extends AsyncTask<String, String, String> {
    ...
    public CreatePdf(ImageToPDFOptionsModel mImageToPDFOptionsModel, String parentPath,
                     OnPDFCreatedInterface onPDFCreated) {
        this.mImagesUri = mImageToPDFOptionsModel.getImagesUri();
        this.mFileName = mImageToPDFOptionsModel.getOutFileName();
        this.mPassword = mImageToPDFOptionsModel.getPassword();
        this.mQualityString = mImageToPDFOptionsModel.getQualityString();
        this.mOnPDFCreatedInterface = onPDFCreated;
        this.mPageSize = mImageToPDFOptionsModel.getPageSize();
        this.mPasswordProtected = mImageToPDFOptionsModel.isPasswordProtected();
        this.mBorderWidth = mImageToPDFOptionsModel.getBorderWidth();
        this.mWatermarkAdded = mImageToPDFOptionsModel.isWatermarkAdded();
        this.mWatermarkModel = mImageToPDFOptionsModel.getWatermark();
        this.mMarginTop = mImageToPDFOptionsModel.getMarginTop();
        this.mMarginBottom = mImageToPDFOptionsModel.getMarginBottom();
        this.mMarginRight = mImageToPDFOptionsModel.getMarginRight();
        this.mMarginLeft = mImageToPDFOptionsModel.getMarginLeft();
        this.mImagescaleType = mImageToPDFOptionsModel.getImageScaleType();
        this.mPageNumStyle = mImageToPDFOptionsModel.getPageNumStyle();
        this.mMasterPwd = mImageToPDFOptionsModel.getMasterPwd();
        mPath = parentPath;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            if (mWatermarkAdded) {
                ...
                watermarkPageEvent.setWatermark(mWatermarkModel);
