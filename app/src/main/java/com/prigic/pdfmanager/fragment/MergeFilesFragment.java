...
import com.prigic.pdfmanager.adapter.MergeSelectedFilesAdapter;
...
import com.prigic.pdfmanager.util.MergePdf;
...
import static com.prigic.pdfmanager.util.MergePdfEnhancementOptionsUtils.getEnhancementOptions;
...
public class MergeFilesFragment extends Fragment implements MergeFilesAdapter.OnClickListener, MergeFilesListener,
    ...
    private ArrayList<EnhancementOptionsEntityModel> mEnhancementOptionsEntityModelArrayList;
  ...
  RadioGroup radioGroupStatus;
    ...
    private void showEnhancementOptions() {
        ...
        mEnhancementOptionsEntityModelArrayList = getEnhancementOptions(mActivity);
        mEnhancementOptionsAdapter = new EnhancementOptionsAdapter(this, mEnhancementOptionsEntityModelArrayList);
        ...
        if (StringUtils.isNotEmpty(mPassword)) {
            neutralAction.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    mPassword = null;
                    MergeFilesFragment.this.onPasswordRemoved();
    ...
    private void onPasswordAdded() {
        mEnhancementOptionsEntityModelArrayList.get(0)
    ...
    void mergeFiles(final View view) {
        final String[] pdfpaths = mFilePaths.toArray(new String[0]);
                ...
                .input(getString(R.string.example), null, new MaterialDialog.InputCallback() {
                    ...
                    public void onInput(@NonNull MaterialDialog dialog, final CharSequence input) {
                        if (StringUtils.isEmpty(input)) {
                            ...
                            if (!mFileUtils.isFileExist(input + MergeFilesFragment.this.getString(R.string.pdf_ext))) {
                                new MergePdf(input.toString(), mHomePath, mPasswordProtected,
                                        mPassword, MergeFilesFragment.this, masterpwd).execute(pdfpaths);
                            } else {
                                ...
                                builder.onPositive(new MaterialDialog.SingleButtonCallback() {
                                    ...
                                    public void onClick(@NonNull MaterialDialog dialog12, @NonNull DialogAction which) {
                                        new MergePdf(input.toString(),
                                                ...
                                                MergeFilesFragment.this, masterpwd).execute(pdfpaths);
                                    }
                                })
