...
import com.prigic.pdfmanager.activity.ImageEditorActivity;
import com.prigic.pdfmanager.activity.RearrangeImagesActivity;
...
import com.prigic.pdfmanager.activity.CropImageActivity;
import com.prigic.pdfmanager.activity.PreviewActivity;
...
import com.prigic.pdfmanager.util.CreatePdf;
...
import static com.prigic.pdfmanager.util.Constants.DEFAULT_BORDER_WIDTH;
import static com.prigic.pdfmanager.util.Constants.DEFAULT_COMPRESSION;
import static com.prigic.pdfmanager.util.Constants.DEFAULT_IMAGE_BORDER_TEXT;
import static com.prigic.pdfmanager.util.Constants.DEFAULT_IMAGE_SCALETYPE_TEXT;
import static com.prigic.pdfmanager.util.Constants.DEFAULT_PAGE_SIZE;
import static com.prigic.pdfmanager.util.Constants.DEFAULT_PAGE_SIZE_TEXT;
import static com.prigic.pdfmanager.util.Constants.DEFAULT_QUALITY_VALUE;
import static com.prigic.pdfmanager.util.Constants.IMAGE_SCALE_TYPE_ASPECT_RATIO;
...
import static com.prigic.pdfmanager.util.ImageEnhancementOptionsUtils.getEnhancementOptions;
import static com.prigic.pdfmanager.util.ImageUtils.mImageScaleType;
...
import static com.prigic.pdfmanager.util.WatermarkUtils.getStyleNameFromFont;
import static com.prigic.pdfmanager.util.WatermarkUtils.getStyleValueFromName;
...
public class ImageToPdfFragment extends Fragment implements OnItemClickListner,
    ...
    private ImageToPDFOptionsModel mPdfOptions;
    ...
    private void showEnhancementOptions() {
        ...
        ArrayList<EnhancementOptionsEntityModel> list = getEnhancementOptions(mActivity, mPdfOptions);
    ...
    void createPdf(final boolean isgrayScale) {
        ...
        builder.input(getString(R.string.example), null, new MaterialDialog.InputCallback() {
            ...
            public void onInput(@NonNull MaterialDialog dialog, CharSequence input) {
                if (StringUtils.isEmpty(input)) {
                    ...
                    if (!utils.isFileExist(filename + ImageToPdfFragment.this.getString(R.string.pdf_ext))) {
                        mPdfOptions.setOutFileName(filename);

                        if (isgrayScale)
                            ImageToPdfFragment.this.saveCurrentImageInGrayscale();
                        ...
                        builder2.onPositive(new MaterialDialog.SingleButtonCallback() {
                            ...
                            public void onClick(@NonNull MaterialDialog dialog1, @NonNull DialogAction which) {
                                ImageToPdfFragment.this.createPdf(isgrayScale);
                            }
                        }).show();
                    }
                }
    ...
    private void addWatermark() {
        ...
        final WatermarkModel watermarkModel = new WatermarkModel();
                ...
                new TextWatcher() {
                    ...
                    public void afterTextChanged(Editable input) {
                        if (StringUtils.isEmpty(input)) {
                            ...
                            watermarkModel.setWatermarkText(input.toString());
        ...
        positiveAction.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                watermarkModel.setWatermarkText(watermarkTextInput.getText().toString());
                watermarkModel.setFontFamily(((Font.FontFamily) fontFamilyInput.getSelectedItem()));
                watermarkModel.setFontStyle(getStyleValueFromName(((String) styleInput.getSelectedItem())));

                if (StringUtils.isEmpty(angleInput.getText())) {
                    watermarkModel.setRotationAngle(0);
                } else {
                    watermarkModel.setRotationAngle(Integer.valueOf(angleInput.getText().toString()));
                }

                if (StringUtils.isEmpty(fontSizeInput.getText())) {
                    watermarkModel.setTextSize(50);
                } else {
                    watermarkModel.setTextSize(Integer.valueOf(fontSizeInput.getText().toString()));
                }

                watermarkModel.setTextColor((new BaseColor(
                ...
                mPdfOptions.setWatermark(watermarkModel);
    ...
    private void resetValues() {
        mPdfOptions = new ImageToPDFOptionsModel();
