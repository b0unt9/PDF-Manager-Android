...
import com.prigic.pdfmanager.util.MergeHelper;
...
import static com.prigic.pdfmanager.util.DialogUtils.showFilesInfoDialog;
        ...
        if (!mCheckBoxChanged) {
            ...
            mSearchView.setOnCloseListener(new SearchView.OnCloseListener() {
                ...
                public boolean onClose() {
                    ViewFilesFragment.this.populatePdfList(null);
                    return false;
                }
            });
        ...
        AlertDialog.Builder dialogAlert = new AlertDialog.Builder(mActivity)
                ...
                .setPositiveButton(R.string.yes, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        ViewFilesFragment.this.checkIfListEmpty();
                    }
                });
