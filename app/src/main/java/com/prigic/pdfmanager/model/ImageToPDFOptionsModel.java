...
public class ImageToPDFOptionsModel extends PDFOptionsModel {
    ...
    public ImageToPDFOptionsModel(String mFileName, String mPageSize, boolean mPasswordProtected,
                                  String mPassword, String mQualityString, int mBorderWidth,
                                  String masterPwd, ArrayList<String> mImagesUri,
                                  boolean mWatermarkAdded, WatermarkModel mWatermarkModel) {
        super(mFileName, mPageSize, mPasswordProtected, mPassword, mBorderWidth, mWatermarkAdded, mWatermarkModel);
